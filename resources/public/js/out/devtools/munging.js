...
var temp__5455__auto____$1 = (o27491["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o27492 = temp__5455__auto____$1;
return (o27492["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27311__auto__ = f;
return (o__27311__auto__["toString"]).call(o__27311__auto__);
} else {
return "";
}
}catch (e27493){var _ = e27493;
return "";
}});
...
try{var o__27311__auto___27495 = t;
(o__27311__auto___27495["cljs$lang$ctorPrWriter"]).call(o__27311__auto___27495,t,writer);
}catch (e27494){var __27496 = e27494;
}
...
var char_code = (function (){var o__27311__auto__ = (new String(char$));
return (o__27311__auto__["charCodeAt"]).call(o__27311__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27311__auto__ = String;
return (o__27311__auto__["fromCharCode"]).call(o__27311__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27497 = num_code;
switch (G__27497) {
case (1):
return (185);
...
var o__27311__auto__ = String;
return (o__27311__auto__["fromCharCode"]).call(o__27311__auto__,superscript_code);
});
/**
...
}catch (e27499){var _e__27318__auto__ = e27499;
return false;
}})())){
...
var vec__27500 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27500,(0),null);
...
var temp__5455__auto____$1 = (o27503["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o27504 = temp__5455__auto____$1;
return (o27504["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___27511 = arguments.length;
var i__4532__auto___27512 = (0);
while(true){
if((i__4532__auto___27512 < len__4531__auto___27511)){
args__4534__auto__.push((arguments[i__4532__auto___27512]));

var G__27513 = (i__4532__auto___27512 + (1));
i__4532__auto___27512 = G__27513;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27507){
var vec__27508 = p__27507;
var ns_detector = cljs.core.nth.call(null,vec__27508,(0),null);
...
var G__27514 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27515 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27514;
remaining_tokens = G__27515;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27505){
var G__27506 = cljs.core.first.call(null,seq27505);
var seq27505__$1 = cljs.core.next.call(null,seq27505);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27506,seq27505__$1);
});
...
var vec__27519 = cljs.core.split_with.call(null,(function (p1__27518_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27518_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27519,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27519,(1),null);
...
var vec__27522 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27522,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27522,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27525 = cljs.core.rest.call(null,remaining_tokens);
var G__27526 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27525;
name_tokens = G__27526;
continue;
} else {
...
var vec__27529 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27529,(0),null);
var arity = cljs.core.nth.call(null,vec__27529,(1),null);
var vec__27532 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27532,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27532,(1),null);
var vec__27535 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27535,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27535,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27535,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27535,(3),null);
...
var vec__27541 = result;
var munged_ns = cljs.core.nth.call(null,vec__27541,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27541,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27541,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27541,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27541,(4),null);
var arity = cljs.core.nth.call(null,vec__27541,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__27545 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__27545,(0),null);
var args = cljs.core.nth.call(null,vec__27545,(1),null);
var vec__27548 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27548,(0),null);
var name = cljs.core.nth.call(null,vec__27548,(1),null);
...
var G__27552 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27553){
var vec__27554 = p__27553;
var arity = cljs.core.nth.call(null,vec__27554,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27554,(1),null);
...
return cljs.core.get.call(null,arities,p1__27557_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__27558_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___27565 = arguments.length;
var i__4532__auto___27566 = (0);
while(true){
if((i__4532__auto___27566 < len__4531__auto___27565)){
args__4534__auto__.push((arguments[i__4532__auto___27566]));

var G__27567 = (i__4532__auto___27566 + (1));
i__4532__auto___27566 = G__27567;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27561){
var vec__27562 = p__27561;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27562,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27559){
var G__27560 = cljs.core.first.call(null,seq27559);
var seq27559__$1 = cljs.core.next.call(null,seq27559);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27560,seq27559__$1);
});
...
var G__27568 = arg;
var G__27568__$1 = (((G__27568 instanceof cljs.core.Keyword))?G__27568.fqn:null);
switch (G__27568__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__27570__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27570__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27570__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27570__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27571 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27571,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27571,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27571,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27571,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27571,(4),null);
var arity = cljs.core.nth.call(null,vec__27571,(5),null);
...
var o__27311__auto__ = f;
return (o__27311__auto__["getBasis"]).call(o__27311__auto__);
});
/**
...
}catch (e27575){var _e__27318__auto__ = e27575;
...
var G__27576 = (obj[cljs.core.first.call(null,path)]);
var G__27577 = cljs.core.rest.call(null,path);
obj = G__27576;
path = G__27577;
continue;
} else {
...
return (function (accum,p__27578){
var vec__27579 = p__27578;
var bit = cljs.core.nth.call(null,vec__27579,(0),null);
var protocol = cljs.core.nth.call(null,vec__27579,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27582){
var vec__27583 = p__27582;
var ns = cljs.core.nth.call(null,vec__27583,(0),null);
var name = cljs.core.nth.call(null,vec__27583,(1),null);
var selector = cljs.core.nth.call(null,vec__27583,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__27588,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27588,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__27588,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27586_SHARP_){
return (obj[cljs.core.first.call(null,p1__27586_SHARP_)]);
});})(name,sorted_matches,vec__27588,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1543433660086
