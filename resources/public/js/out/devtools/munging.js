...
var o27371 = temp__5455__auto__;
var temp__5455__auto____$1 = (o27371["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o27372 = temp__5455__auto____$1;
return (o27372["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27191__auto__ = f;
return (o__27191__auto__["toString"]).call(o__27191__auto__);
} else {
return "";
}
}catch (e27373){var _ = e27373;
return "";
}});
...
try{var o__27191__auto___27375 = t;
(o__27191__auto___27375["cljs$lang$ctorPrWriter"]).call(o__27191__auto___27375,t,writer);
}catch (e27374){var __27376 = e27374;
}
...
var char_code = (function (){var o__27191__auto__ = (new String(char$));
return (o__27191__auto__["charCodeAt"]).call(o__27191__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27191__auto__ = String;
return (o__27191__auto__["fromCharCode"]).call(o__27191__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27377 = num_code;
switch (G__27377) {
case (1):
return (185);
...
var o__27191__auto__ = String;
return (o__27191__auto__["fromCharCode"]).call(o__27191__auto__,superscript_code);
});
/**
...
}catch (e27379){var _e__27198__auto__ = e27379;
return false;
}})())){
...
var vec__27380 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27380,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o27383 = temp__5455__auto__;
var temp__5455__auto____$1 = (o27383["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o27384 = temp__5455__auto____$1;
return (o27384["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___27391 = arguments.length;
var i__4532__auto___27392 = (0);
while(true){
if((i__4532__auto___27392 < len__4531__auto___27391)){
args__4534__auto__.push((arguments[i__4532__auto___27392]));

var G__27393 = (i__4532__auto___27392 + (1));
i__4532__auto___27392 = G__27393;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27387){
var vec__27388 = p__27387;
var ns_detector = cljs.core.nth.call(null,vec__27388,(0),null);
...
var G__27394 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27395 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27394;
remaining_tokens = G__27395;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27385){
...
var vec__27399 = cljs.core.split_with.call(null,(function (p1__27398_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27398_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27399,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27399,(1),null);
...
var vec__27402 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27402,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27402,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27405 = cljs.core.rest.call(null,remaining_tokens);
var G__27406 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27405;
name_tokens = G__27406;
continue;
} else {
...
var vec__27409 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27409,(0),null);
var arity = cljs.core.nth.call(null,vec__27409,(1),null);
var vec__27412 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27412,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27412,(1),null);
var vec__27415 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27415,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27415,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27415,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27415,(3),null);
...
var vec__27421 = result;
var munged_ns = cljs.core.nth.call(null,vec__27421,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27421,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27421,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27421,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27421,(4),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__27425 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__27425,(0),null);
var args = cljs.core.nth.call(null,vec__27425,(1),null);
var vec__27428 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27428,(0),null);
var name = cljs.core.nth.call(null,vec__27428,(1),null);
...
var G__27431 = (arity + (1));
var G__27432 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27433){
var vec__27434 = p__27433;
var arity = cljs.core.nth.call(null,vec__27434,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27434,(1),null);
...
return cljs.core.get.call(null,arities,p1__27437_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__27438_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27441){
var vec__27442 = p__27441;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27442,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27439){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__27450__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27450__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27450__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27450__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27451 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27451,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27451,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27451,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27451,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27451,(4),null);
var arity = cljs.core.nth.call(null,vec__27451,(5),null);
...
var o__27191__auto__ = f;
return (o__27191__auto__["getBasis"]).call(o__27191__auto__);
});
/**
...
}catch (e27455){var _e__27198__auto__ = e27455;
...
var G__27456 = (obj[cljs.core.first.call(null,path)]);
var G__27457 = cljs.core.rest.call(null,path);
obj = G__27456;
path = G__27457;
continue;
} else {
...
return (function (accum,p__27458){
var vec__27459 = p__27458;
var bit = cljs.core.nth.call(null,vec__27459,(0),null);
var protocol = cljs.core.nth.call(null,vec__27459,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27462){
var vec__27463 = p__27462;
var ns = cljs.core.nth.call(null,vec__27463,(0),null);
var name = cljs.core.nth.call(null,vec__27463,(1),null);
var selector = cljs.core.nth.call(null,vec__27463,(2),null);
...
return (function (p__27467){
var vec__27468 = p__27467;
var munged_name = cljs.core.nth.call(null,vec__27468,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27468,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__27468,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27466_SHARP_){
return (obj[cljs.core.first.call(null,p1__27466_SHARP_)]);
});})(name,sorted_matches,vec__27468,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1535318443355
