...
var vec__23579_23582 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_23583 = cljs.core.nth.call(null,vec__23579_23582,(0),null);
var only_after_23584 = cljs.core.nth.call(null,vec__23579_23582,(1),null);
var db_changed_QMARK__23585 = ((!((only_before_23583 == null))) || (!((only_after_23584 == null))));
if(db_changed_QMARK__23585){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_23583);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_23584);
...
var map__23586 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__23586__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__23586__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__23588 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__23588__$1;
var event = cljs.core.get.call(null,map__23588__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
/** @this {Function} */
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq23590){
...
var args__4534__auto__ = [];
var len__4531__auto___23599 = arguments.length;
var i__4532__auto___23600 = (0);
while(true){
if((i__4532__auto___23600 < len__4531__auto___23599)){
args__4534__auto__.push((arguments[i__4532__auto___23600]));

var G__23601 = (i__4532__auto___23600 + (1));
i__4532__auto___23600 = G__23601;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__23594_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__23595_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__23595_SHARP_);
...
/** @this {Function} */
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq23596){
var G__23597 = cljs.core.first.call(null,seq23596);
var seq23596__$1 = cljs.core.next.call(null,seq23596);
var G__23598 = cljs.core.first.call(null,seq23596__$1);
var seq23596__$2 = cljs.core.next.call(null,seq23596__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23597,G__23598,seq23596__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1543435802829
