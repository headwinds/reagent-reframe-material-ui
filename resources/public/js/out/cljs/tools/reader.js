...
var G__31882 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__31882;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__31883 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__31883,ch);
...
if(("\\" === ch__$1)){
var ch_31884__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_31884__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_31884__$2);
} else {
}

var G__31885 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__31885;
continue;
}
}
...
var vec__31893 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__31893,(0),null);
var start_column = cljs.core.nth.call(null,vec__31893,(1),null);
...
var G__31896 = cljs.core.conj_BANG_.call(null,a,form);
a = G__31896;
continue;
}
}
...
var _STAR_read_delim_STAR_31897 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_31897;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__31898 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__31898,(0),null);
var start_column = cljs.core.nth.call(null,vec__31898,(1),null);
...
var vec__31901 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__31901,(0),null);
var end_column = cljs.core.nth.call(null,vec__31901,(1),null);
...
var vec__31904 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__31904,(0),null);
var start_column = cljs.core.nth.call(null,vec__31904,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__31910,(0),null);
var start_column = cljs.core.nth.call(null,vec__31910,(1),null);
...
var vec__31913 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__31913,(0),null);
var end_column = cljs.core.nth.call(null,vec__31913,(1),null);
...
var sb = (function (){var G__31916 = (new goog.string.StringBuffer());
G__31916.append(initch);
...
var G__31918 = (function (){var G__31917 = sb;
G__31917.append(ch);

return G__31917;
})();
var G__31919 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__31918;
ch = G__31919;
continue;
}
...
switch (G__31922) {
case "\\":
var G__31926 = (function (){var G__31923 = sb;
G__31923.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__31923;
})();
var G__31927 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__31926;
ch = G__31927;
continue;
...
break;
default:
var G__31928 = (function (){var G__31924 = sb;
G__31924.append(ch);
...
var vec__31930 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__31930,(0),null);
var end_column = cljs.core.nth.call(null,vec__31930,(1),null);
...
var vec__31933 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__31933,(0),null);
var column = cljs.core.nth.call(null,vec__31933,(1),null);
...
var vec__31938 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__31938,(0),null);
var column = cljs.core.nth.call(null,vec__31938,(1),null);
...
var line = cljs.core.nth.call(null,vec__31943,(0),null);
var column = cljs.core.nth.call(null,vec__31943,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__31948 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__31948,(0),null);
var start_column = cljs.core.nth.call(null,vec__31948,(1),null);
...
var vec__31951 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__31951,(0),null);
var end_column = cljs.core.nth.call(null,vec__31951,(1),null);
...
var G__31954 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__31954,true,null,opts,pending_forms);
...
var G__31955 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__31955)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__31955)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__31955)){
...
var _STAR_suppress_read_STAR_31956 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_31956;
}});
...
var G__31957 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__31957,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__31957,rdr,first_line);
...
var G__31961 = matched;
var G__31962 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__31961;
finished = G__31962;
continue;
} else {
...
var _STAR_suppress_read_STAR_31963 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_31963;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env31964 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__31965 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__31965,"(");
...
var G__31966 = (i + (1));
var G__31967 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3949__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env31964;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__31968 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__31968);
...
var G__31969 = cljs.core.next.call(null,s__$1);
var G__31970 = ret;
s__$1 = G__31969;
r = G__31970;
continue;
...
var G__31971 = cljs.core.next.call(null,s);
var G__31972 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__31971;
key_vals = G__31972;
continue;
} else {
...
var gensym_env31976 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env31976;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__31977 = token;
var G__31977__$1 = (((G__31977 == null))?null:cljs.core.subs.call(null,G__31977,(1)));
var G__31977__$2 = (((G__31977__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__31977__$1));
var G__31977__$3 = (((G__31977__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__31977__$2));
var G__31977__$4 = (((G__31977__$3 == null))?null:cljs.core.symbol.call(null,G__31977__$3));
if((G__31977__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__31977__$4);
}
})():(function (){var G__31978 = token;
var G__31978__$1 = (((G__31978 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__31978));
if((G__31978__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__31978__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e31985){if((e31985 instanceof Error)){
var e = e31985;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__31989,reader){
...
var eof = cljs.core.get.call(null,map__31990__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq31996){
var G__31997 = cljs.core.first.call(null,seq31996);
var seq31996__$1 = cljs.core.next.call(null,seq31996);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31997,seq31996__$1);
});


//# sourceMappingURL=reader.js.map?rel=1535318449831
