...
example.view.primary_color_blue = "#1976d2";
example.view.custom_theme = example.view.global$module$material_ui$styles.createMuiTheme.call(null,({"palette": ({"primary": ({"main": example.view.primary_color_blue})})}));
