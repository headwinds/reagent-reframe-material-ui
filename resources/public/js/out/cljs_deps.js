...
goog.addDependency("../example/routes.js", ['example.routes'], ['example.demos.demo_button', 'example.demos.demo_splash', 'reagent.core', 'cljs.core', 'goog.history.EventType', 'example.events', 'goog.History', 'example.demos.table.demo_table', 'example.demos.demo_text_field', 'secretary.core', 'example.subs', 'goog.events', 're_frame.core', 'example.utils.http_fx']);
